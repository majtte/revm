...
## [13.0.1](https://github.com/bluealloy/revm/compare/revm-context-v13.0.0...revm-context-v13.0.1) - 2026-01-19

### Other

- updated the following local packages: revm-primitives, revm-bytecode, revm-database, revm-state, revm-database-interface, revm-context-interface
