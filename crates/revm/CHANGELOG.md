...
## [34.0.1](https://github.com/bluealloy/revm/compare/revm-v34.0.0...revm-v34.0.1) - 2026-01-19

### Other

- updated the following local packages: revm-primitives, revm-bytecode, revm-database, revm-interpreter, revm-precompile, revm-inspector, revm-state, revm-database-interface, revm-context-interface, revm-context, revm-handler, revm-statetest-types
